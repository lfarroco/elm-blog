...
var _lfarroco$elm_blog$Main$menuItems = {
	...
	_1: {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: '#Contato', _1: 'Contato'},
				_1: {ctor: '[]'}
			}
		}
	}
...
var _lfarroco$elm_blog$Main$menu = function () {
	...
	return function (_p4) {
		return nav(
			A2(_elm_lang$core$List$map, item, _p4));
	};
}();
var _lfarroco$elm_blog$Main$p = function (_p5) {
	return A2(
...
var _lfarroco$elm_blog$Main$article = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('3 de dezembro de 2017'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _lfarroco$elm_blog$Main$article,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _lfarroco$elm_blog$Main$init = {ctor: '_Tuple2', _0: 2, _1: _elm_lang$core$Platform_Cmd$none};
...
var _lfarroco$elm_blog$Main$posts_url = 'https://api.github.com/repos/lfarroco/elm-blog/contents/posts';
var _lfarroco$elm_blog$Main$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _lfarroco$elm_blog$Main$main !== 'undefined') {
    _lfarroco$elm_blog$Main$main(Elm['Main'], 'Main', undefined);
}
